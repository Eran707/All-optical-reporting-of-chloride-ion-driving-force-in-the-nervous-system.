...
ORCHID modelling with 2 compartments only
...
file_name = "default_trial"

sim = simulator_2_levels.Simulator(file_name)

# Intracellular compartment
L1 = compartment.Compartment("L1", radius=5e-5, length=25e-5)
L1.set_ion_properties(na_i=14e-3, cl_i=5.2e-3, k_i=122.9e-3, hco3_i=15e-3, x_i=154.9e-3, z_i=-0.85)
# Extracellular compartment
L2 = compartment.Compartment("L2", radius=5e-5, length=25e-5)
L2.set_ion_properties(na_i=145e-3, cl_i=108e-3, k_i=3.5e-3, hco3_i=31e-3, x_i=40.5e-3, z_i=-1)
...
#sim.add_synapse(start_t=120, duration=20 * 1e-3, max_neurotransmitter=30e-3, synapse_conductance=10e-9)

#sim.set_KCC2_change(start_t=3000, end_t=6000, final_KCC2_value=0)
#sim.add_synapse(start_t=900, duration=20 * 1e-3, max_neurotransmitter=30e-3, synapse_conductance=10e-9)

#sim.set_zchange(start_t=3000, end_t=6000, z_change=-0.2, adjust_cl=False, target_vm=0)
