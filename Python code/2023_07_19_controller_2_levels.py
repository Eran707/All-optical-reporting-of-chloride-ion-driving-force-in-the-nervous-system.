...
file_name = "kcc2_off_trial1"

sim = simulator_2_levels.Simulator(file_name)

# Intracellular compartment
L1 = compartment.Compartment("L1", radius=5e-5, length=25e-5)
L1.set_ion_properties(na_i=14e-3, cl_i=5.2e-3, k_i=122.9e-3, hco3_i=25e-3, x_i=154.9e-3, z_i=-0.85)
# Extracellular compartment
L2 = compartment.Compartment("L2", radius=5e-5, length=25e-5)
L2.set_ion_properties(na_i=145e-3, cl_i=108e-3, k_i=3.5e-3, hco3_i=31.4e-3, x_i=40.5e-3, z_i=-1)
...
total_t = 12000
time_step = 1e-4
sim.set_timing(total_t=total_t, time_step=time_step, intervals=12000)
